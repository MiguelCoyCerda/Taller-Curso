...
namespace sage.addons.Taller.Visual.UserControls
{
    ...
    /// </summary>
    public partial class txtconductores : ewtxtcodlabel
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public txtconductores()
        {
        }
        ...
        protected override void _Cargar_Propiedades()
        {
            ...
            _Browser_Condicion = "";
            _Browser_Tabla = "conductores";
            _Browser_Titulos_Campos = "Código,Nombre";
            _Browser_Titulo = "Listado de mantenimiento de conductores";
        }
    }
}
